...
function WorldPage() {
  ...
  return (
    <div className="fixed inset-0 w-full h-full overflow-hidden bg-gray-900" style={{ minHeight: '100vh', minHeight: '100dvh' }}>  
      ...
      {isPanelExpanded ? (
        <div className="absolute top-20 left-2 md:left-4 z-5 flex justify-start">
          <button
        ...
        <div className="absolute top-20 left-2 md:left-4 z-5 flex gap-2">
          <button
          ...
          >
            ...
            <span className="font-semibold whitespace-nowrap truncate max-w-[140px] text-xs md:text-sm">
